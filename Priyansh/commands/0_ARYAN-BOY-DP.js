...
     ];
     var callback = () => api.sendMessage({body:`☟  ========== ☟ ==========  ☟          💐𝐇𝐄𝐑𝐄 𝐈𝐒 𝐘𝐎𝐔𝐑 𝐒𝐀𝐃 𝐏𝐇𝐎𝐓𝐎💐                                         ●===========================●                              𝐎𝐰𝐧𝐞𝐫➻ ╔╬⓼★⓼╃───────➣™𝐃𝐀𝐍𝐈 𝐌𝐀𝐋𝐈𝐊𝄠━─━Ⓔ╰✾✾®️╀✿✿╀─━ↈⓇ⧐⧐💐`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
